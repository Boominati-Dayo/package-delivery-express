        ...
        <div className="grid md:grid-cols-2 gap-4 md:gap-6">
          <div className={`rounded-xl p-4 md:p-6 ${isDarkMode ? 'bg-slate-800' : 'bg-white shadow-lg'}`}>
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center gap-3"><FaPhone className="text-[#22c55e] flex-shrink-0" /><span className="text-gray-900 dark:text-white text-sm break-all">{shipment.shipperPhone}</span></div>
              <div className="flex items-center gap-3"><FaEnvelope className="text-[#22c55e] flex-shrink-0" /><span className="text-gray-900 dark:text-white text-sm break-all">{shipment.shipperEmail}</span></div>
            </div>
          </div>
          ...
          <div className={`rounded-xl p-4 md:p-6 ${isDarkMode ? 'bg-slate-800' : 'bg-white shadow-lg'}`}>
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center gap-3"><FaPhone className="text-[#22c55e] flex-shrink-0" /><span className="text-gray-900 dark:text-white text-sm break-all">{shipment.receiverPhone}</span></div>
              <div className="flex items-center gap-3"><FaEnvelope className="text-[#22c55e] flex-shrink-0" /><span className="text-gray-900 dark:text-white text-sm break-all">{shipment.receiverEmail}</span></div>
            </div>
          </div>
        </div>
