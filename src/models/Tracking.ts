...
const PackageSchema = new Schema<IPackage>({
  ...
  pieceType: { type: String, default: 'Box' },
...
const TrackingSchema = new Schema<ITracking>(
  {
    ...
    productQuantity: { type: String, default: '1' },
    paymentMode: { type: String, required: true },
    totalFreight: { type: String, default: '0' },
    // Schedule
    ...
    shipmentHistory: { type: [ShipmentHistorySchema], default: [] },
    // Status
    status: { type: String, default: 'Pending' },
    currentLocation: { type: String, default: '' },
    showLiveMap: { type: Boolean, default: false },
